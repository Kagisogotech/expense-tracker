  ...
  return (
    <div className="bg-neutral-800/50 backdrop-blur-sm border border-neutral-700 p-6 rounded-2xl">
      <div className="text-center mb-4">
        ...
        <p className={`text-3xl sm:text-4xl font-bold ${balance >= 0 ? 'text-neutral-100' : 'text-red-500'}`}>
      ...
      <div className="flex justify-around bg-neutral-900/50 p-4 rounded-xl">
        <div className="text-center">
          ...
          <p className="text-xl sm:text-2xl font-bold text-emerald-400">{formatCurrency(totalIncome)}</p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-xl sm:text-2xl font-bold text-red-500">{formatCurrency(totalExpense)}</p>
        </div>
      </div>
    </div>
  );
